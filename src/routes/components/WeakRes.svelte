<script>
    import {Bug, Dark, Dragon, Electric, Fairy, Fighting, Fire, Flying, Ghost, Grass, Ground, Ice, Normal, Poison, Psychic, Rock, Steel, Water} from "../../lib"
    ...
    for (let i = 0; i < pokeData[0].types.length; i++) {

        if (pokeData[0].types[i].type.name == "bug") {
            // resistances
        ...
        if (pokeData[0].types[i].type.name == "dark") {
        ...
        if (pokeData[0].types[i].type.name == "dragon") {
        ...
        if (pokeData[0].types[i].type.name == "electric") {
            resWeak.Electric = resWeak.Electric * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "fairy") {
            resWeak.Fighting = resWeak.Fighting * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "fighting") {
            resWeak.Bug = resWeak.Bug * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "fire") {
            resWeak.Fire = resWeak.Fire * 0.5;
            resWeak.Grass = resWeak.Grass * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "flying") {
            resWeak.Grass = resWeak.Grass * 0.5;
            resWeak.Fighting = resWeak.Fighting * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "ghost") {
        ...
        if (pokeData[0].types[i].type.name == "grass") {
            resWeak.Water = resWeak.Water * 0.5;
            resWeak.Electric = resWeak.Electric * 0.5;
            resWeak.Grass = resWeak.Grass * 0.5;
            resWeak.Ground = resWeak.Ground * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "ground") {
            resWeak.Poison = resWeak.Poison * 0.5;
            resWeak.Rock = resWeak.Rock * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "ice") {
            resWeak.Ice = resWeak.Ice * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "normal") {
            resWeak.Ghost = resWeak.Ghost * 0;

            resWeak.Fighting = resWeak.Fighting * 2;
        }

        if (pokeData[0].types[i].type.name == "poison") {
            resWeak.Grass = resWeak.Grass * 0.5;
            resWeak.Fighting = resWeak.Fighting * 0.5;
            resWeak.Poison = resWeak.Poison * 0.5;
            resWeak.Bug = resWeak.Bug * 0.5;
        ...
        if (pokeData[0].types[i].type.name == "psychic") {
            resWeak.Fighting = resWeak.Fighting * 0.5
        ...
        if (pokeData[0].types[i].type.name == "rock") {
        ...
        if (pokeData[0].types[i].type.name == "steel") {
            resWeak.Normal = resWeak.Normal * 0.5
            resWeak.Grass = resWeak.Grass * 0.5
            resWeak.Ice = resWeak.Ice * 0.5
        ...
        if (pokeData[0].types[i].type.name == "water") {
            resWeak.Fire = resWeak.Fire * 0.5
            resWeak.Water = resWeak.Water * 0.5
            resWeak.Ice = resWeak.Ice * 0.5
            resWeak.Steel = resWeak.Steel * 0.5
